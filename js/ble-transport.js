            ...
            try {
                ...
                if (pendingLen > 0) {
                    ...
                    try {
                        ...
                        const incomplete =
                            /insufficient data|unexpected end|not enough/i.test(
                                msg,
                            );
                        if (incomplete) {
        ...
        while (off < payload.length) {
            ...
            while (true) {
                ...
                try {
                    ...
                    currentChunk = Math.max(
                        MIN_CHUNK,
                        Math.floor(currentChunk / 2),
                    );
